...
export function Game() {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between'>
      <div className='flex h-[95vh] flex-col items-center pb-2 lg:h-full lg:flex-1 lg:items-start lg:justify-end lg:pb-0'>
        ...
        <button
          onClick={scrollToTop}
          className='rounded-full text-slate-900 transition-colors duration-100 hover:text-slate-900/80 dark:text-slate-200 dark:hover:text-slate-50/80 lg:hidden'
        >
